...
<div align="center">
  ...
  <p>
    <em>
      Image of two Bose-Einstein condensates moving in opposite directions after 18 ms of time of flight. The atoms collide and create a scattering pattern that is not fully described classically. There is a faint presence of atoms that end up in the left side of the brightest cloud (there is no such trace in the right side) thus indicating that they come from some sort of quantum depletion during the dynamical process. The image was taken by
