...
<div align="center">
  ...
  <p><em>Image of two Bose-Eintein condensates moving in opposite directions after 18 ms of time of flight. The atoms collide and create a scattering pattern that is not fully described classically. Notice that there is a faint sign of atoms that end up in the left side of the brightest cloud (there is no such trace in the right side) thus indicating that they come from quantum depletion of the ground state.</em></p>
</div>
